...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Persist the desktop sidebar state across reloads.
...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Reserve layout width so content does not jump when the desktop sidebar collapses. */}
      <div
...
function SidebarMenuSkeleton({
  ...
  // Vary skeleton widths slightly so placeholder rows do not look mechanically identical.
